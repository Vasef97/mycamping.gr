A fully functional and responsive Express Node.js CRUD web application that uses MongoDB as its main database system and conforms to the REST architectural style.
